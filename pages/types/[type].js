    ...
    <>
      ...
      {loading
        ...
        <main className='flex py-2 my-2 flex-col flex-wrap justify-center items-center content-center'>
          <header className='flex flex-wrap row justify-between items-center content-center w-4/5 text-center rounded-lg bg-yellow-200 py-2 px-5 border-t-4 border-b-4 border-yellow-400 pt-3 text-blue-700 '>
            <Image
              width={80}
              height={80}
            ...
            <h1 className='text-5xl font-semibold'>{type.charAt(0).toUpperCase() + type.slice(1)}</h1>
            <Image
              width={80}
              height={80}
              src={`/types/Pokemon_Type_Icon_${type}.svg`}
